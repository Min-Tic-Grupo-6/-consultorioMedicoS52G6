CREATE DATABASE  IF NOT EXISTS `consultorionline` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `consultorionline`;
-- MySQL dump 10.13  Distrib 8.0.26, for Win64 (x86_64)
--
-- Host: localhost    Database: consultorionline
-- ------------------------------------------------------
...
CREATE TABLE `agendamiento` (
  ...
  `hora cita` datetime DEFAULT NULL,
  `costo_cita` int DEFAULT NULL,
  `id_medico` int DEFAULT NULL,
  `id_paciente` int DEFAULT NULL,
  `tipo_enfermedad` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2021-09-18 20:46:52
